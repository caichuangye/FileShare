                ...
                try {
                    ...
                    if (cursor != null) {
                        while (cursor.moveToNext()) {
                            ...
                            if(size > 0) {
                                CommonFileItem item = new CommonFileItem(title, path, size, false,
                                        String.valueOf(CommonUtil.getCommonFileCoverId(path)),
                                        CommonFileItem.FileType.valueOfString(typeStr));
                                mFileList.add(item);
                            }
                        }
                    }
